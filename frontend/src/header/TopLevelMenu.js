...
const TopLevelMenu = ({loggedInPlayer, multiplayerEnabled, discordClientId}) => {
    ...
    const discordLoginUrl = 'https://discord.com/api/oauth2/authorize?client_id='+discordClientId+'&redirect_uri='+
