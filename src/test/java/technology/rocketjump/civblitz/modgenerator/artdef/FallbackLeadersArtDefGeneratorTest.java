...
@SpringBootTest
class FallbackLeadersArtDefGeneratorTest {
	@Autowired
	FallbackLeadersArtDefGenerator generator2;
	...
	void getsOutput() {
		...
		System.out.println(generator2.getFileContents(modHeader, moddedCivInfo));
	}
}