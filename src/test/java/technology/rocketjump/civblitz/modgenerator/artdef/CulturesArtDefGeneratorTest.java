...
@SpringBootTest
class CulturesArtDefGeneratorTest {
	@Autowired
	CulturesArtDefGenerator culturesArtDefGenerator;
	...
	void getsOutput() {
		...
		System.out.println(culturesArtDefGenerator.getFileContents(modHeader, moddedCivInfo));
	}
}