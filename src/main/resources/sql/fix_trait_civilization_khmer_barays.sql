...
VALUES
    ('REQUIRES_PLOT_ADJACENT_TO_BATH_BARAYS_<modName>', 'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES', 0),
    ('REQUIRES_PLOT_NOT_ADJACENT_TO_AQUEDUCT_BARAYS_<modName>', 'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES', 1);
INSERT OR REPLACE INTO RequirementArguments (RequirementId, Name, Value)
VALUES
    ('REQUIRES_PLOT_ADJACENT_TO_BATH_BARAYS_<modName>', 'DistrictType', 'DISTRICT_BATH'),
    ('REQUIRES_PLOT_NOT_ADJACENT_TO_AQUEDUCT_BARAYS_<modName>', 'DistrictType', 'DISTRICT_AQUEDUCT');
...
VALUES
    ...
    ('PLOT_IS_FARM_BATH_ADJACENT_BARAYS_<modName>_REQUIRMENTS', 'REQUIRES_PLOT_NOT_ADJACENT_TO_AQUEDUCT_BARAYS_<modName>');
...
INSERT OR REPLACE INTO Requirements (RequirementId, RequirementType, Inverse)
VALUES
    ('REQUIRES_PLOT_ADJACENT_TO_LAVRA_BARAYS_<modName>', 'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES', 0),
    ('REQUIRES_PLOT_NOT_ADJACENT_TO_HOLY_SITE_BARAYS_<modName>', 'REQUIREMENT_PLOT_ADJACENT_DISTRICT_TYPE_MATCHES', 1);
INSERT OR REPLACE INTO RequirementArguments (RequirementId, Name, Value)
VALUES
    ('REQUIRES_PLOT_ADJACENT_TO_LAVRA_BARAYS_<modName>', 'DistrictType', 'DISTRICT_LAVRA'),
    ('REQUIRES_PLOT_NOT_ADJACENT_TO_HOLY_SITE_BARAYS_<modName>', 'DistrictType', 'DISTRICT_HOLY_SITE');
...
VALUES
    ...
    ('PLOT_IS_FARM_LAVRA_ADJACENT_BARAYS_<modName>_REQUIRMENTS', 'REQUIRES_PLOT_NOT_ADJACENT_TO_HOLY_SITE_BARAYS_<modName>');
